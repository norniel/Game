...
namespace Engine
{
    public class InnerMap:IMap
    {
        ...
        private void ApplySpoileringBehavior(GameObject gameObject)
        {
            ...
            {
                new ObjectState(currentStateName, spoileringBehavior.StayingProps, withObjectWithStates.ObjectWithState.CurrentState?.Id, withObjectWithStates.ObjectWithState.CurrentState?.BaseId),
